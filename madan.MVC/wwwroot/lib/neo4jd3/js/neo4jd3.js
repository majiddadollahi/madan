...
function Neo4jD3(_selector, _options) {
    var container, graph, info, node, nodes, relationship, relationshipOutline, relationshipOverlay,
        relationshipText, relationships, selector, simulation, svg, svgNodes, svgRelationships, svgScale, svgTranslate,
...
*/
    ...
    function updateInfo(d) {
        ...
        if (d.labels) {
            appendInfoElementClass('class', NodeName( d.labels[0]));
        } else {
            appendInfoElementRelationship('class', NodeName(d.type));
        }
